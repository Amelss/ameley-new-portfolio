      ...
      <div className="">
        ...
        <div className=" bg-gray-100 pb-20">
          <div className="xl:max-w-[1100px] xl:mx-auto 2xl:max-w-[1100px] 2xl:mx-auto">
            <h1 className="font-bold text-sm text-center py-5">
              Technical Knowledge
            </h1>
            <h1 className="font-bold text-center pb-5 mb-6 text-3xl xl:text-4xl bg-gradient-to-r from-black via-slateBlue to-lavender text-transparent bg-clip-text ">
              My Skills
            </h1>
        ...
        <div className="py-10 xl:max-w-[1100px] xl:mx-auto 2xl:max-w-[1200px] 2xl:mx-auto">
          ...
          <h1 className="font-bold text-center pb-7 xl:pb-14 text-2xl xl:text-4xl bg-gradient-to-r from-black via-slateBlue to-lavender text-transparent bg-clip-text ">
            Recent Projects
          </h1>
